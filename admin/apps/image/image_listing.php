...
<?php
		...
		//print_r($_POST);
			...
			$result=$m_image->getRelationshipPlaque($_GET['id']);
			$result2=$m_image->getRelationshipAward($_GET['id']);
			$result3=$m_image->getRelationshipLand($_GET['id']);
...
?>
	...
	<table>
			...
			<tr>
				...
				<td>
				<a href="javascript:confirmation(<? echo $row['pkimage_id'].",'{$row['image_name']}','index.php?page=image_listing&id='"; ?>)">delete</a>
				</td>
