...
<script type="text/javascript" href="../includes/scripts.js"></script>
...
function confirmation(ID,Name,url) {
	var answer = confirm("Delete entry "+Name+" ?")
	if (answer){
		alert("Entry Deleted")
		window.location = url+ID+"&name="+Name;
	}
	else{
...
require_once('includes/savethumb.php');


if (!(isset($_SESSION['username'])))
{
?>
<a href="index.php?page=user_forgot_password">Forgot password</a>
	<form name='form'  action='index.php' method='post' onsubmit='javascript: return validate();'>
		...
		<input type="password" name='pass' value="password..." onblur="if(this.value=='') { this.value='password...'};" onfocus="if(this.value=='password...') {this.value='';};" /><input id="btn" name='login' type='submit' value='login' />
  </form>
<?php
}else{
?>
...
<input id="btn" name='logout' type='submit' value='logout' />
</form>
